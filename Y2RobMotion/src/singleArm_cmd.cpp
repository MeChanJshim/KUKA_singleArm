...
constexpr int ROBOT_HZ = 500;
constexpr double CONTROL_PERIOD = 1.0 / ROBOT_HZ;

// Directories
constexpr char PACKAGE_PATH[] = "/home/jay/kuka_singleArm/src/y2_kuka_control/Y2RobMotion";
constexpr char LOAD_FILE[] = "txtcmd/cmd_9D.txt";
